...
/**
 * Created by Evan Hou on 2016/9/8.
 */
 ...
 */
public class MyCacheDb extends SQLiteOpenHelper {
    private static final int DB_VERSION = 1;
    private static final String DB_NAME = "news_caches.db";
    private static final String DB_TABLE ="news";   //创建表名为news的表
    ...
    public MyCacheDb(Context context){
